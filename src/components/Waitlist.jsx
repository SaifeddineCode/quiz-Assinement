...
// Slice your filtered data
const currentData = finalResult.slice(indexOfFirst, indexOfLast);

// Total pages
const totalPages = Math.ceil(finalResult.length / itemsPerPage);


// const filtredService= finalResult.slice(0,10)
    ...
    <div className='flex flex-col gap-5 w-full md:flex-1 min-w-0'>
      ...
      <div className='w-full overflow-x-auto'>
        ...
        <table className='w-full'>
          ...
          <div className='w-full'>No Data matches your filter</div>
          : 
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between mt-4 px-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="px-3 py-1 text-sm rounded-md border border-gray-300 text-gray-600 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Previous
          </button>
